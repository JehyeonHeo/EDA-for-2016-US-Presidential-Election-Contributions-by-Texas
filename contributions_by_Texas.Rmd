...
print(paste('<B>Number of candidates in Data:</B>'))
length(unique(Data$cand_nm))

# Show some contributers' names.
print(paste("<B>Show top 5 most common contributers' names</B>"))
...
print(paste('<B>How many unique city names are registered for him?</B>'))
length(unique(bonnie$contbr_city))

print(paste('<B>What are the city names?<\B>'))
unique(bonnie$contbr_city)

print(paste('<B>How many unique zip codes are registered for him?</B>'))
length(unique(bonnie$contbr_zip))

print(paste('<B>What are the zip codes?</B>'))
unique(bonnie$contbr_zip)

print(paste('<B>How many of people are registered as his employer?</B>'))
length(unique(bonnie$contbr_employer))

print(paste('<B>Who are his employers?</B>'))
unique(bonnie$contbr_employer)

print(paste('<B>How many occupations are registered for him?</B>'))
length(unique(bonnie$contbr_occupation))

print(paste('<B>What are his occupations?</B>'))
...
# Set locale of R.
print(paste("<B>Set locale as 'C'</B>"))
...
print(paste("<B>If the unique values of the candidates' names in Data are all equal to the values in cand:</B>"))
...
print(paste('<B>Show the names of the columns after merged</B>'))
names(Data)
```
...
print(paste("<B>Number of contributers' cities</B>"))
...
print(paste('<B>Top 6 most frequent contribution amounts:</B>'))
...
print(paste('<B>Top 6 negative amounts:</B>'))
head(sort(minus_amounts$contb_receipt_amt))

print(paste('<B>Datas whose contribution amounts are less than -$10,000:</B>'))
subset(minus_amounts, contb_receipt_amt < -10000)

print(paste('<B>Datas about DURHAM, JOE and CLARK, ELLOINE M.</B>'))
...
print(paste('<B>Top 6 most common descriptions for negative values:</B>'))
...
print(paste('<B>Show the counts of contribution amounts whose values are above $5,400.</B>'))
sort(table(more_than_5400_amounts$contb_receipt_amt),
     decreasing = T)

print(paste('<B>Top 6 descriptions for amounts whose values are above $5,400:</B>'))
...
print(paste('<B>Top 6 most frequent contribution dates:</B>'))
...
print(paste('<B>Head and tail parts of datas whose election type is O2016</B>'))
o2016 = subset(Data, election_tp == 'O2016')
head(o2016)
tail(o2016)

print(paste('<B>Are all O2016 contributions for Jill Stein?</B>'))
all(o2016$cand_nm == 'Stein, Jill')

print(paste('<B>Since When and till when the contributions are received?</B>'))
range(o2016$contb_receipt_dt)

print(paste('<B>Datas whose election type is P2012</B>'))
...
print(paste("<B>Head and tail parts of datas whose election type is ''</B>"))
election_type_vacant <- subset(Data, election_tp == '')
head(election_type_vacant)
tail(election_type_vacant)

print(paste('<B>For whom are the contributions?</B>'))
unique(election_type_vacant$cand_nm)

print(paste('<B>Since when and till when the nominees received them?</B>'))
...
print(paste("<B>Since when and till when the candidates who aren't nominees received them?</B>"))
...
print(paste('<B>When did the worst collapsion happened?</B>'))
unique(contbs_in_worst_collapsion_date$contb_receipt_dt)

print(paste('<B>How many contributions were done at the date?</B>'))
...
```
 ...
 Second plot is bar graph which shows the median, mean and 0.95 quantile amounts by each top 10 city. It shows that 0.95 quantile value of Dallas was really big. The mean of Dallas was biggest too but not much different from Houston.
