...
==================================================
 ...
 First, I want to know how the contribution counts for each candidate are differed by each city. Therefore I'm going to use cand_nm and cand_party columns. And I'll use line graph because I need to show the differences of several candidates by each city. It is inconvenient to compare when multiple bars are used for each legend.
...
### Description One
 ...
 I changed the graph type from barplot to line graph to show the counts and sums at once in the graph.
