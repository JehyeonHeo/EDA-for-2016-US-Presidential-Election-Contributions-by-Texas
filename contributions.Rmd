...
```{r echo=FALSE, Multivariate_line_for_amt_dt_main_nominees}
...
```{r echo=FALSE, Multivariate_line_for_amt_dt_Republican_main_cands}
...
```{r echo=FALSE, Multivariate_line_for_amt_dt_Democratic_main_cands}
...
```{r echo=FALSE, Multivariate_line_for_amt_dt_party}
...
```{r echo=FALSE, Multivariate_box_for_amt_party_facet_type}
...
```{r echo=FALSE, Multivariate_scatter_for_amt_dt_party}
...
```{r echo=FALSE, Multivariate_scatter_for_amt_dt_main_cands}
...
```{r echo=FALSE, Multivariate_line_for_amt_dt_party_city}
...
```{r echo=FALSE, Multivariate_line_for_amt_city_party_type}
...
```{r echo=FALSE, Multivariate_line_for_party_city_facet_type}
...
ggplot(aes(x = cand_nm),
  ...
  ylab('Sum of Contribution Cmounts\nContribution Counts(x100)') +
  ggtitle(
