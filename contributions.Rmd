...
```
 ...
 The minimun and maximum amount was -16600$ and 15,000$ each. It is weird that there are - values of contributions. I need to find what causes it.
...
```{r echo=FALSE, Univariate_contribution_date}

# I'm going to show the distribution of contribution dates in Texas.
