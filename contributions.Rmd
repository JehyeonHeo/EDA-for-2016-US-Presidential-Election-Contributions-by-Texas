...
# Show the counts of top 10 results.
ggplot(aes(x = name, y = count),
...
```
 ...
 The minimum and maximum amount was -\$16,600 and \$15,000 each. It is weird that there are - values of contributions. I need to find what causes it.
...
# I want to know why negative values appear in amounts.
# Subset data whose amount values are below 0.
...
# Show the top 6 descriptions for negative values.
...
# Show the top 6 descriptions for amounts whose values are above $5,400.
...
# I'm going to show the distribution of contributions for each parties in Texas.

# Get counts of contributions by parties.
parties_counts <- as.data.frame(table(Data$cand_party, dnn = 'party'),
                                      responseName = 'count')

# Show the counts.
parties_counts[order(-parties_counts$count),]
...
# I'm going to show the distribution of contributions for nominees and those who aren't in Texas. 

# Get counts of contributions by if_nominee.
nominees_counts <- as.data.frame(table(Data$if_nominee, dnn = 'if_nominee'),
                                      responseName = 'count')

# Show the counts.
nominees_counts[order(-nominees_counts$count),]
...
# Make new dataframe.
new.Data <- Data[, chosenColumns]

# Exclude election type P2012 and O2016.
new.Data <- subset(new.Data, !election_tp %in% c('P2012', 'O2016'))

# Show the structure of new.Data.
str(new.Data)
```
...
# I want to know how the contribution amounts changed as time goes on.
# Therefore I'm going to use contb_receipt_amt and contb_receipt_dt columns.
# And I'll use line graph to show the trend of contribution amounts.
...
# This time, I'll use scatter plot to show the distributions of amounts by date.
...
# I want to know how the contribution amounts are differed for nominees group and other candidates group.
# Therefore I'm going to use contb_receipt_amt and if_nominee columns.
# And I'll use boxplot and barplot to show the differences.
...
ggplot(aes(x = if_nominee, y = contb_receipt_amt),
       data = subset(new.Data,
                     contb_receipt_amt > quantile(contb_receipt_amt, 0.1) &
                       contb_receipt_amt < quantile(contb_receipt_amt, 0.9))) +
  geom_boxplot(alpha = 0.2) +
  geom_point(stat = 'summary', fun.y = mean, size = 3, shape = 8) +
  scale_x_discrete()
...
# I want to know how the contribution amounts are differed by parties.
# Therefore I'm going to use contb_receipt_amt and cand_party columns.
# And I'll use boxplot and barplot to show the differences.
...
# I want to know how the contribution amounts are differed by candidates.
# Therefore I'm going to use contb_receipt_amt and cand_nm columns.
# And I'll use boxplot and barplot to show the differences.
...
ggplot(aes(x = cand_nm, y = contb_receipt_amt),
       data = subset(new.Data,
                     contb_receipt_amt > quantile(contb_receipt_amt, 0.1) &
                       contb_receipt_amt < quantile(contb_receipt_amt, 0.9))) +
  geom_boxplot(alpha = 0.2) +
  geom_point(stat = 'summary', fun.y = mean, size = 1, shape = 8) +
  scale_x_discrete() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
...
# I want to know how the contribution amounts are differed by election types.
# Therefore I'm going to use contb_receipt_amt and election_tp columns.
# And I'll use boxplot and barplot to show the differences.
...
# I want to know how the contribution amounts are differed by cities.
# Therefore I'm going to use contb_receipt_amt and contbr_city columns.
# And I'll use boxplot and barplot to show the differences.

sum_amounts_by_city <- new.Data %>%
...
top10_sum_amounts_city <- subset(new.Data,
                                 contbr_city %in% 
...
ggplot(aes(x = contbr_city, y = contb_receipt_amt, group = 1),
       data = top10_sum_amounts_city) +
  geom_line(stat = 'summary', fun.y = length) +
  scale_x_discrete() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
...
# I want to know how the contribution counts changed as time goes on.
# And I especially want to compare between the candidates who became nominees and those who couldn't.
# Therefore I'm going to use contb_receipt_dt and if_nominee columns.
# And I'll use line graph to show the trend of contribution counts.

ggplot(aes(x = contb_receipt_dt, y = if_nominee, color = if_nominee),
       data = new.Data) +
  geom_line(stat = 'summary', fun.y = sum) +
  scale_x_date(date_breaks = '3 month') +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
...
# I want to know how the contribution counts changed as time goes on.
# And I especially want to compare between the parties.
# Therefore I'm going to use contb_receipt_dt and cand_party columns.
# And I'll use line graph to show the trend of contribution counts.

ggplot(aes(x = contb_receipt_dt, y = cand_party, color = cand_party),
       data = new.Data) +
  geom_line(stat = 'summary', fun.y = sum) +
  scale_x_date(date_breaks = '3 month') +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
...
```{r echo=FALSE, Bivariate_for_date_and_main_candidates}

# I want to know how the contribution counts changed as time goes on.
# And I especially want to compare between Trump and Clinton.
# Therefore I'm going to use contb_receipt_dt and cand_nm columns.
# And I'll use line graph to show the trend of contribution counts.

p1 <- ggplot(aes(x = contb_receipt_dt, y = cand_nm, color = cand_nm),
             data = subset(new.Data,
...
p2 <- p1 + 
  scale_x_date(limits = c(as.Date('2016-06-01'), as.Date('2016-11-30')),
               date_breaks = '1 month')
...
# I want to know how the contribution counts changed as time goes on.
# And I especially want to compare by election types.
# Therefore I'm going to use contb_receipt_dt and election_tp columns.
# And I'll use line graph to show the trend of contribution counts.

ggplot(aes(x = contb_receipt_dt, y = election_tp, color = election_tp),
       data = new.Data) +
  geom_line(stat = 'summary', fun.y = sum) +
  scale_x_date(date_breaks = '3 month') +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
