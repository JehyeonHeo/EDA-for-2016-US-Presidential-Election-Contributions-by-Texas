...
```
 ...
 I think that it is good to add new column which notify who became presidential nominee from each party. I'm going to assign TRUE for nominees and FALSE for others. And I'm going to regard Evan McMullin, independent presidential candidate as a nominee.
