...
ggplot(aes(x = contbr_city, y = contb_receipt_amt, group = 1),
  ...
  geom_line(stat = 'summary', 
            fun.y = median) +
  geom_line(stat = 'summary', 
            fun.y = quantile, fun.args = list(probs = 0.05)) +
  scale_x_discrete() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
